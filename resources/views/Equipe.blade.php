      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les équipes</li>
          </ol>
        </nav>
...
<div class="page-section bg-light">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Les Équipes</h1>
      <div class="row mt-5">
      @if(count($equipes)>0)
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog"> 
            <div class="header">
              ...
              <a href="{{route('equipe.show',$equipe->id)}}" class="post-thumb">
                <img src="{{asset('/images/profs/'.$equipe->photo)}}" alt="">
              </a>
            </div>
            <div class="body">
              <h5 class="post-title"><a href="{{route('equipe.show',$equipe->id)}}">{{$equipe->nom}} ({{$equipe->achro}})</a></h5>
              <div class="site-info">
                <div class="avatar mr-2">
                  
                </div>
                <span ></span> Domaine de {{$equipe->achro}} : {{$equipe->domaine}}
              </div>
            </div>
          </div>
        </div>
